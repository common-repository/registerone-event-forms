jQuery(document).ready(function($) {
    ...
    var masking = {
        ...
        setCreditCardType: function(e, firstDigit) {
            ...
            // alert(registerOne.pluginsUrl);
            // https://forms.registerone.net/wp-content/plugins
            var icon_url = registerOne.pluginsUrl + '/registerone-event-forms/front-end/assets/img/icons/' + cc.card + '.png';
